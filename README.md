...
This folder is a standalone static web app for Christendom Budget.
...
Christendom Budget saves the transaction into SQLite and uploads the updated `budget.sqlite3` to GitHub.
...
- Accounts
- Categories
- Monthly budgets with category defaults and reset-from-defaults
- Debts
